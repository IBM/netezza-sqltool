...
class AbstractDriver {
    ...
    createSshTunnel(ssh, db, tunnelOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const [sshTunnel] = yield (0, tunnel_ssh_1.createTunnel)(Object.assign({ autoClose: true, reconnectOnError: false }, tunnelOptions), null, Object.assign(Object.assign({ host: ssh.host, port: ssh.port, username: ssh.username }, (ssh.password ? { password: ssh.password } : {})), (ssh.privateKeyPath ? { privateKey: fs_1.default.readFileSync(ssh.privateKeyPath) } : {})), {
                dstAddr: db.host,
                dstPort: db.port,
            });
            return {
                port: sshTunnel.address().port,
                close: () => {
                    sshTunnel.close();
                },
            };
